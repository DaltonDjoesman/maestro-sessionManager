# 78143c99-2647-4fc6-b41d-9996fa3bed6d implementation handoff

This archive is the source of truth for turning the design into production code. Start from `maestro-desktop-prototype.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `maestro-desktop-prototype.html`
...
- A single self-contained `maestro-desktop-prototype.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `maestro-desktop-prototype.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `maestro-desktop-prototype.html`
...
- `drawing-2026-07-14T16-00-09-533Z.png`
- `drawing-2026-07-14T16-03-20-459Z.png`

## Coding checklist for AI tools
1. Inspect `maestro-desktop-prototype.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
