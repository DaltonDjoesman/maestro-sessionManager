...
- [ ] 1.1 Add `docs/backend-workflow.md` listing Superpowers skill paths (TDD, verification-before-completion, systematic-debugging), scope `src-tauri/`, and verification commands (`cargo test`, `npm run build` when UI/types change)
