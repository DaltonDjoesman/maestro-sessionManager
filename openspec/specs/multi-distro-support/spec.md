# multi-distro-support Specification

## Purpose

Packaging and desktop-environment coverage across major Linux families; compositor adapters with honest degradation; maintainer docs for deps per distro family.
