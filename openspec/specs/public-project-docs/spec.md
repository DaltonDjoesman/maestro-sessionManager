# public-project-docs Specification

## Purpose
Normative expectations for LICENSE, portfolio README, screenshots, contributing note, architecture overview, and security blurb for a public personal repository.
